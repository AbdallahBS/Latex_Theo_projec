...
\vskip1cm
\textsc{\large Rapport de Projet de Fin d’Etude}\\[0.5cm] % Minor heading such as course title\\
...
\HRule \\[0.4cm]
\textcolor{blue}{ \LARGE \bfseries Nom du projet}\\[0.3cm] % Title of your document
\HRule \\[1cm]
